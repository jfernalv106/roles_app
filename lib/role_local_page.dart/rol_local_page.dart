  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      ...
      child: Container(
        ...
        child: Column(
          children: [
            BlocBuilder<RolLocalBloc, RolLocalState>(builder: (context, bloc) {
              if (bloc.roles != null) {
                ...
                return TextButton(
                    onPressed: () async {
                      ...
                      final punto = PerimetroLocal()
                        ..latitud = state.locacion.lastKnownLocation!.latitude
                        ..longitud =
                            state.locacion.lastKnownLocation!.longitude;
                      for (var rl in roles) {
                        final role = Calculos.calculaPuntosCercanos(rl, punto);
                        if (role != null) {
                          rll.add(role);
                        }
                      }
